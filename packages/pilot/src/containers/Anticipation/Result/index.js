...
class AnticipationResult extends Component {
  ...
  renderInformationRow () {
    ...
    return (
      <Summary>
        <DataDisplay
          title={t('pages.anticipation.ancitipation_date')}
          value={formatLongDate(date)}
        />
        <TotalDisplay
          amount={requested}
          color="#37cc9a"
          title={t('pages.anticipation.gross_value')}
          unit={t('pages.anticipation.currency_symbol')}
        />
        <TotalDisplay
          amount={totalCost}
          color="#ff796f"
          title={t('pages.anticipation.total_cost')}
          unit={t('pages.anticipation.currency_symbol')}
        />
        <TotalDisplay
          amount={amount}
          color={chooseTotalDisplayColor(amount)}
          title={t('pages.anticipation.ancitipation_value')}
          unit={t('pages.anticipation.currency_symbol')}
        />
      </Summary>
    )
                    ...
                    <Row>
                      <Col>
                        <span className={style.information}>
                          ...
                          {automaticTransfer && (
                            <Fragment>
                              <Spacing size="small" /><span>|</span><Spacing size="small" />
                              {t('pages.anticipation.automatic_transfer_to_bank_account')}
                            </Fragment>
                          )}
                        </span>
                      </Col>
